...
import { getMediaStream, getMediaStreamH5 } from '@/services/monitor';
...
const FlvVideoH5: React.FC<Iprops> = forwardRef(
  ({ id, xtoken, autoplay = true, type = 'flv', ...rest }, ref) => {
    ...
    const fetchDeviceInfo = async (
      ...
      const res = await getMediaStreamH5(
        {
          deviceId: params.id,
