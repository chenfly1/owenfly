import { getModuleAllList, globalResourceSync } from '@/services/wps';
import { ExclamationCircleFilled, SearchOutlined } from '@ant-design/icons';
import { Input, Button, Drawer, Tree, Modal, message, Space, Card } from 'antd';
...
const SyncResourceModal: React.FC<IProps> = (props) => {
    ...
    try {
      confirm({
        ...
        onOk: async () => {
          ...
          const res = await globalResourceSync(paramsList);
          if (res.code === 'SUCCESS') {
...
export default SyncResourceModal;
