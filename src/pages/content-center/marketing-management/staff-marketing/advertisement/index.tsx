      ...
      confirm({
        ...
        content: (
          <p>
            ...
            下线该计划，{row.projectNames}将不展示个人中心广告位
          </p>
        ),
        centered: true,
        okText: '确认下线',
            ...
            actions={[
              {
                key: 'edit',
                text: '编辑',
                accessKey: 'alitaContent_editPlanB',
                onClick() {
                  setEditData(record);
              ...
              },
              {
                key: 'down',
                text: '下线',
                accessKey: 'alitaContent_onlinePlanB',
  ...
  return (
    <PageContainer header={{ title: null }}>
      <ProTable<planContentPageType>
        ...
        toolBarRender={() => [
          <Access key="add" accessible={access.functionAccess('alitaContent_addPlanB')}>
            <Button
              key="button"
              onClick={() => {
                setEditData({});
