...
export default () => {
  ...
  const columns: ProColumns<ParkAreaType>[] = [
    ...
    },
    {
      ...
      valueEnum: {
        ...
        98: '盘点离场',
        99: '虚拟放行',
        // 入场放行方式 0未知，1自动放行，2确认放行，3异常放行，4遥控开闸，5自助开闸，6可疑跟车，7盘点进场，8离线自动放行，9离线遥控放行，98盘点离场，99虚拟放行
      },
    },
  ...
  // const tableColumns: ProColumns[] = columns.map((column, index) => ({ ...column }));

  const queryList = async (params: any) => {
    params.pageNo = params.current;
    if (params.entryTime) {
      params.entryStartTime = params.entryTime[0] + ' 00:00:00';
      params.entryEndTime = params.entryTime[1] + ' 23:59:59';
    }
    params.plateStatus = 1;
