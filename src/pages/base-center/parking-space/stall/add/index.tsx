...
import { createParkingPlace, getProjectDetails, getResourceEnum } from '@/services/mda';
...
const StallAdd: FC<Record<string, any>> = () => {
  ...
  const onFinish = async (values: Record<string, any>) => {
    ...
    try {
      console.log(values);
      const res = await createParkingPlace(values);
      if (res.code === 'SUCCESS') {
