...
Upload.Behavior = createBehavior(
  {
    name: 'Upload',
    extends: ['Field'],
    selector: (node: any) => node.props['x-component'] === 'Upload',
    designerProps: {
      propsSchema: createFieldSchema(fieldProperty)(AllSchemas.Upload),
    },
  ...
  },
  {
    name: 'Upload.Dragger',
    extends: ['Field'],
    selector: (node: any) => node.props['x-component'] === 'Upload.Dragger',
    designerProps: {
      propsSchema: createFieldSchema(fieldProperty)(AllSchemas.Upload.Dragger),
    },
