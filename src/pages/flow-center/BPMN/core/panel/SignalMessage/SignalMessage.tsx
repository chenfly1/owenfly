...
import EditSignalMessage from './EditSignalMessage/EditSignalMessage';
  ...
  return (
    <>
      <Space direction="vertical" size={4} style={{ display: 'flex' }}>
        ...
        />
        <EditSignalMessage createType={'message'} initRows={initRows} rowIds={messageIds} />
        <Table
        ...
        />
        <EditSignalMessage createType={'signal'} initRows={initRows} rowIds={signalIds} />
      </Space>
    </>
  );
}
