...
import { script_type, script_type_options } from '../../ElementListener/dataSelf';
...
export default function ScriptTask(props: IProps) {
  ...
  function updateScriptTask() {
    ...
    if (form.getFieldValue(keyOptions.scriptType) === script_type.inlineScript) {
    ...
    taskAttr[keyOptions.scriptFormat] = form.getFieldValue(keyOptions.scriptFormat);
    taskAttr[keyOptions.resultVariable] = form.getFieldValue(keyOptions.resultVariable);
