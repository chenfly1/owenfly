      ...
      extra={[
        <ProFormSwitch
          ...
          fieldProps={{
            ...
            onChange: () => {
              history.push({
                pathname: '/pass-center/dashboard/singleProject',
              });
            },
          }}
        />,
      ...
      <div className={styles.cusWarp}>
        <ProCard style={{ marginTop: '10px' }} bordered split="horizontal">
          ...
          <ProCard split="vertical">
            ...
            >
              <AuthLineChartCard qryType={qryType} projectIds={projectIds} />
            </ProCard>
            <ProCard colSpan={'35%'} title="当前设备类型占比">
              <DevicesPreChartCard projectIds={projectIds} />
            </ProCard>
          </ProCard>
          <ProCard split="vertical">
            <ProCard
            ...
            >
              <PassLineChartCard passType={passType} projectIds={projectIds} />
            </ProCard>
            <ProCard
              title={
                <>
              ...
              colSpan={'35%'}
            >
              <PassPreChartCard projectIds={projectIds} />
            </ProCard>
          </ProCard>
        </ProCard>
      </div>
